...
Users.find_all_by_ids = function(idsArr, call_back) {
  ...
  this.db.query('SELECT id,lastname,firstname,title,email,admin,active FROM users WHERE ' + queryStringArray.join(" OR ") + ';', idsArr, function (err, rows, fields) {
